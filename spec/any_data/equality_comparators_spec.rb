[
  { method: 'equality',         comparators: %w(equals eq "=\ "),          expected: [true,  false, false, false, false ]},
  { method: 'non equality',     comparators: %w(not_equals neq "!="),      expected: [false, true,  true,  false, false ]},
  { method: 'greater equal to', comparators: %w(greater_equal_to ge ">="), expected: [true,  true,  false, false, false ]},
  { method: 'greater than',     comparators: %w(greater_than gt ">\ "),    expected: [false, true,  false, false, false ]},
  { method: 'less equal to',    comparators: %w(less_equal_to le "<="),    expected: [true,  false, true,  false, false ]},
  { method: 'less than',        comparators: %w(less_than lt "<\ "),       expected: [false, false, true,  false, false ]},
