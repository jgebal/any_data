create or replace type any_data_bdouble under any_data(
   ...
   constructor function any_data_bdouble( p_data binary_double ) return self as result
);
/
...
create or replace type body any_data_bdouble as
   ...
   constructor function any_data_bdouble( p_data binary_double ) return self as result is
      begin
