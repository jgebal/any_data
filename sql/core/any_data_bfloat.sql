create or replace type any_data_bfloat under any_data(
   ...
   constructor function any_data_bfloat( p_data binary_float ) return self as result
);
/
...
create or replace type body any_data_bfloat as
   ...
   constructor function any_data_bfloat( p_data binary_float ) return self as result is
      begin
