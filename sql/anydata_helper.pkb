create or replace package body anydata_helper as
   ...
   function to_char( p_variable varchar2, p_format_string varchar2 := null ) return varchar2 is
      begin
   ...
   function substr( p_variable varchar2, p_start int, p_how_many int := null ) return varchar2 is
      begin
   ...
   function dbms_lob_substr( p_variable varchar2, p_how_many int, p_start int := null ) return varchar2 is
      begin
         return 'dbms_lob.' || substr( p_variable, p_how_many, p_start );
      end;

   function utl_raw_cast_to_varchar2( p_variable varchar2 ) return varchar2 is
      begin
         return 'utl_raw.cast_to_varchar2( ' || p_variable || ' )';
      end;

   function trim( p_variable varchar2 ) return varchar2 is
      begin
